...
## Type: Dict
# c.aliases = {'qa': 'quit', 'wqa': 'quit --save', 'w': 'session-save', 'q': 'close', 'wq': 'quit --save'}
...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Shift-Enter>': '<Return>', '<Shift-Return>': '<Return>', '<Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-J>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>'}
...
config.bind('qj', 'leave-mode', mode='command')
config.bind('jq', 'leave-mode', mode='command')
...
config.bind('qj', 'leave-mode', mode='hint')
config.bind('jq', 'leave-mode', mode='hint')
# config.bind('<Return>', 'follow-hint', mode='hint')

## Bindings for insert mode
# config.bind('<Ctrl-E>', 'open-editor', mode='insert')
# config.bind('<Escape>', 'leave-mode', mode='insert')
config.bind('qj', 'leave-mode', mode='insert')
config.bind('jq', 'leave-mode', mode='insert')
