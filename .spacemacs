...
layers configuration. You are free to put any user code."
  ...
  ;; Space-Tab (should...) autocorrect to nearest valid word.
  ;; (spacemacs/set-leader-keys <tab> 'helm-flyspell-correct)
  

  ;; If there's a problem with werid highlighting of insert mode commands in a terminal-like buffer..
  ;; Go to 22:51 here: https://www.youtube.com/watch?v=HKF41ivkBb0
